...
void networking::LinuxSocket::bindSocket()
{
...
void networking::LinuxSocket::listenSocket()
{
	if (listen(m_serverSocket, constants::backlogSize) == -1)
	{
...
std::string networking::LinuxSocket::getClientIP(std::shared_ptr<Connection> connection)
{
...
nlohmann::json networking::LinuxSocket::generateResponse(const nlohmann::json request)
{
...
void networking::LinuxSocket::handleConnection(std::shared_ptr<Connection> connection)
{
...
void networking::LinuxSocket::acceptConnection()
{
